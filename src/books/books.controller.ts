...
export class BooksController {
  ...
  async getBookById(@Param('bookId') bookId: string): Promise<BooksResDto> {
  ...
  async createBook(@Body() params: BooksReqDto): Promise<BooksResDto> {
  ...
  async deleteBook(@Param('bookId') bookId: string): Promise<BooksResDto> {
